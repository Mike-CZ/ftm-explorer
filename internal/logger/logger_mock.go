...
// ModuleLogger indicates an expected call of ModuleLogger.
func (mr *MockLoggerMockRecorder) ModuleLogger(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ModuleLogger", reflect.TypeOf((*MockLogger)(nil).ModuleLogger), arg0)
}
