...
func (m *MockRpc) MazePlayerPosition(arg0 context.Context, arg1, arg2 common.Address) (uint16, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MazePlayerPosition", arg0, arg1, arg2)
	ret0, _ := ret[0].(uint16)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRpcMockRecorder) MazePlayerPosition(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MazePlayerPosition", reflect.TypeOf((*MockRpc)(nil).MazePlayerPosition), arg0, arg1, arg2)
}
